...
def create_augmented_dataset(src_root, dst_root, augmentation_per_cat_image=4, augmentation_per_dog_image=2, train_ratio=0.8):
    """
    ...
    Args:
        ...
        augmentation_per_cat_image (int): Number of augmented versions to create per cat image
        augmentation_per_dog_image (int): Number of augmented versions to create per dog image
    ...
    for i, idx in enumerate(train_indices):
        ...
        # Determine if this is a cat or dog image
        cat_pixels = np.sum(seg_mask == 1)
        dog_pixels = np.sum(seg_mask == 2)
        is_cat_image = cat_pixels > dog_pixels
        
        # Set number of augmentations based on class
        augmentation_per_image = augmentation_per_cat_image if is_cat_image else augmentation_per_dog_image
...
if __name__ == "__main__":
    ...
    dst_dataset_root = '../Dataset_augmented_cats/'
    
    # Create augmented dataset
    create_augmented_dataset(src_dataset_root, dst_dataset_root, augmentation_per_cat_image=4, augmentation_per_dog_image=2)
