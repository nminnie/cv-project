...
class Encoder(nn.Module):
    def __init__(self, latent_dim=256):
        ...
        self.encoder = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.AdaptiveAvgPool2d((7, 7)),  # Ensure consistent output size (latent_dim, 7, 7)
        )
...
class Decoder(nn.Module):
    def __init__(self, latent_dim=256):
        ...
        self.decoder = nn.Sequential(
            ...
            nn.ConvTranspose2d(latent_dim, 512, kernel_size=4, stride=2, padding=1),  # (512, 14, 14)
            nn.BatchNorm2d(512),
            nn.ReLU(inplace=True),
            ...
            nn.Conv2d(32, 3, kernel_size=3, stride=1, padding=1),  # (3, 224, 224)
...
if __name__ == "__main__":
    ...
    train_pipeline(
        ...
        device, "runs/autoencoder_resized/augmented_weighted_20epochs",
